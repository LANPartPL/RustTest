...
lazy_static::lazy_static! {
    ...
    pub static ref PROD_RENDEZVOUS_SERVER: RwLock<String> = RwLock::new("rustdesk.lanpart.pl".to_owned());
    pub static ref EXE_RENDEZVOUS_SERVER: RwLock<String> = Default::default();
    pub static ref APP_NAME: RwLock<String> = RwLock::new("LANPart".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rustdesk.lanpart.pl"];
pub const RS_PUB_KEY: &str = "OffD2ILSAsT+Mv+FPHZeTNyXFLTLoMMvgJjDK+DLxXc=";
